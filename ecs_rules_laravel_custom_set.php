...
return static function (ECSConfig $ecsConfig) : void {
    ...
    $ecsConfig->rulesWithConfiguration([ClassAttributesSeparationFixer::class => ['elements' => ['const' => 'none', 'method' => 'one', 'property' => 'none', 'trait_import' => 'none']], ClassDefinitionFixer::class => ['multi_line_extends_each_single_line' => true, 'single_item_single_line' => true, 'single_line' => true]]);
    ...
    $ecsConfig->rules([NoUnneededCurlyBracesFixer::class, NoUnreachableDefaultArgumentValueFixer::class, NoUnsetCastFixer::class, NoUnusedImportsFixer::class, NoUselessReturnFixer::class, NoWhitespaceBeforeCommaInArrayFixer::class, NoWhitespaceInBlankLineFixer::class, NormalizeIndexBraceFixer::class, ObjectOperatorWithoutWhitespaceFixer::class]);
