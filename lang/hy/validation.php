...
return [
    ...
    'attributes'           => [
        ...
        'year'                     => 'տարի',
        'custom' => [
            'terms_1' => 'Ընդհանուր Դրույթներ և Պայմաններ',
            'terms_2' => 'Նախագծի պայմաններ',
            'terms_3' => 'Ուղղորդման ծառայությունների դրույթներ',
            'terms_5' => 'Լիցենզային պայմանագիր',
            'terms_6' => 'Գաղտնիության քաղաքականություն',
        ],
    ],
    ...
    */
    ...
    'custom' => [
        'phone_number' => [
            'string' => 'Դաշտի ձևաչափը սխալ է։ Մուտքագրեք հեռախոսահամարը առանց միջազգային կոդի (55 123456)',
        ],
        'verification' => [
            'incorrect' => 'Հաստատման կոդը սխալ է',
            'expired'   => 'Հաստատման կոդը ժամկետանց է',
            'not_found' => 'Մենք չկարողացանք գտնել որևէ սկզբնական նախահաշիվ Ձեր էլ․փոստով։ Դուք կարող եք ստեղծել նորը',
        ],
        'eligibility' => [
            'general' => 'Նախահաշվարկը չի համապատասխանում որևէ վարկատեսակին',
            'max_amount' => 'Նախահաշվարկի գումարը գերազանցում է :amount դրամը',
            'min_amount' => 'Նախահաշվարկի գումարը չի գերազանցում :amount դրամը',
            'electronics' => 'Կենցաղային սարքավորումների ձեռքբերման նախահաշվարկը գերազանցում է ընդհանուրի 10%-ը',
        ],
    ],
